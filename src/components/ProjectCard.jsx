...
const ProjectCard = ({ image, liveLink, gitLink, name, description, tools }) => {
  return (
    <div className="group/video hover:border-purple-500 transition-transform hover:duration-200 hover:ease-in-out hover:scale-103 duration-200 ease-in hover:shadow-purple-400 hover:shadow-sm rounded-2xl shadow-lg w-[332px] h-[544px] gap-4 bg-gray-950 flex flex-col shadow-violet-950 p-4 overflow-hidden">
      {/* Video */}
